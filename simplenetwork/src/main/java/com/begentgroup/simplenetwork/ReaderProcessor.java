 ...
 */
public abstract class ReaderProcessor<T,E> extends Processor<T,E> {
    @Override
    ...
    protected E errorProcess(ResponseBody body) throws IOException {
        return errorProcess(body.charStream());
    }

    abstract protected T process(Reader reader) throws IOException;
    abstract protected E errorProcess(Reader reader) throws IOException;
}
